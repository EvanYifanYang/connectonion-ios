...
//  AgentInfo.swift
//
//  Purpose: Implements AgentInfo for the Core/Models/Agent module.
//  Collaborates with: AgentAcceptedInputs, AgentAddress, AgentConfig, AgentInfo+Merging, SkillInfo.
