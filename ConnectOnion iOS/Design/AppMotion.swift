...
//  AppMotion.swift
//
//  Purpose: Implements AppMotion for the Design module.
//  Collaborates with: AppColors, AppTheme, AppearanceMode, BrandColor, GlassSurfaceModifier, QuietPressButtonStyle.
