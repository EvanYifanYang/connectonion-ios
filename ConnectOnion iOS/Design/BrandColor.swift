...
//  BrandColor.swift
//
//  Purpose: Implements BrandColor for the Design module.
//  Collaborates with: AppColors, AppMotion, AppTheme, AppearanceMode, GlassSurfaceModifier, QuietPressButtonStyle.
