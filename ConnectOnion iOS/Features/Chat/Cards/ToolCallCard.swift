...
//  ToolCallCard.swift
//
//  Purpose: Implements ToolCallCard for the Features/Chat/Cards module.
//  Collaborates with: ApprovalButtons, ApprovalNeededCard, AskUserCard, OnboardRequiredCard, PlanReviewCard, ToolCallGroupCard.
