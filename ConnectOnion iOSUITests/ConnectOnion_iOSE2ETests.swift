//
//  ConnectOnion_iOSE2ETests.swift
//
//  Purpose: Implements ConnectOnion_iOSE2ETests for the ConnectOnion iOSUITests module.
//  Collaborates with: ConnectOnion_iOSUITests.
