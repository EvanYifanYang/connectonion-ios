//
//  ConnectOnionWidget.swift
//
//  Purpose: Implements ConnectOnionWidget for the ConnectOnionWidget module.
//  Collaborates with: ConnectOnionLiveActivity, ConnectOnionWidgetBundle.
